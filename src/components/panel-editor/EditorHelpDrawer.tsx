  ...
  return (
    <div>
      ...
      <CollapsibleSection title="Properties Panel">
        ...
        <p><strong className="text-white/80">Resize is locked while rotated</strong> &mdash; for any control with CSS rotation applied (non-fader controls at any non-zero angle, or faders at non-cardinal angles), the corner resize handles disappear. Reason: Rnd&rsquo;s handles sit at the un-rotated bbox corners, so dragging what looks like the visual-right corner actually grows the un-rotated height &mdash; confusing. Workflow: set Rotate to 0&deg;, resize via corner handles or the W/H inputs, then re-apply your rotation. Faders/sliders at 90&deg;/270&deg; remain resizable because the auto-swap aligns their bbox with the visual.</p>
